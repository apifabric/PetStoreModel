...
resourcename="petstoremodel"  # lower case, only
resourcegroup="petstoremodel_rg"
...
# git clone https://github.com/apilogicserver/petstoremodel.git
# cd petstoremodel
...
az group create --name petstoremodel_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group petstoremodel_rg --sku S1 --is-linux
az container create --resource-group petstoremodel_rg --name petstoremodel --image apilogicserver/petstoremodel:latest --dns-name-label petstoremodel --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//petstoremodel.westus.azurecontainer.io:5656'
